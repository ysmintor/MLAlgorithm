...
# 读取mnist训练数据。
minst_path = '/Users/york/MasterCourse/数据分析工具实践/Lectures/第10次课/Tensorflow-Chapter05/MNIST_data'
mnist = input_data.read_data_sets(minst_path,dtype=tf.uint8, one_hot=True)
